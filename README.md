...
8. Press the ```All Run``` button. If you've compiled with ```All Compile``` button. Then run it automatically with PsExec64.exe as System Privilege. Or, find the executable file in the cpp directory and run it.
